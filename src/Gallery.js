...
const Gallery = () => {
	return (
		<div className="container mx-auto">
			...
			>
				{otherGalleryItems.map((item) => {
					return (
						<img
							src={item.imageSource}
							className={`h-14 rounded-tl-2xl rounded-br-2xl shadow-md ${
			...
			{/* <div
				className={`absolute top-0 left-0 w-full h-full bg-gray-200 bg-opacity-80`}
			>
				<div className="w-full mx-auto">
					<div className="w-3/4 bg-red-200 h-20 absolute top-50 left-50">
						<img src={selectedImage.imageSource} />
					</div>
				</div>
			</div> */}
		</div>
